...
parser.add_argument('--datapath', default= root_path+'/Dataset/KITTI/object/training/',
                    help='select model')
parser.add_argument('--loadmodel', default=root_path+'/Dataset/psmnet/kitti_3d/finetune_300.tar',
                    help='loading model')
...
parser.add_argument('--save_path', type=str, default=root_path+'/Dataset/KITTI/object/training/predict_disparity_926', metavar='S',
...
def main():
    ...
    processed = preprocess.get_transform(augment=False) #新增
