...
def project_disp_to_depth(calib, disp):
    # 视差图 最小值为0, ul - ur 为左右图横坐标之差,
    # 根据相机图像坐标系定义(以光心为中心)以ul>0,ur为负值
    disp[disp < 0] = 0
    baseline = 0.54
    mask = disp > 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--disparity_dir', type=str,
                        default=root_path+'/Dataset/KITTI/object/testing/predict_disparity_sceneflow')
    parser.add_argument('--save_dir', type=str,
                        default=root_path+'/Dataset/KITTI/object/testing/predict_velodyne_sceneflow/')
