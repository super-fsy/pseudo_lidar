...
if __name__ == '__main__':
    ...
    parser.add_argument('--lidar_dir', default=root_path+'/Dataset/KITTI/object/testing/pseudo-lidar_velodyne_finetune300_selftrain/')
    parser.add_argument('--planes_dir', default=root_path+'/Dataset/KITTI/object/testing/pseudo-lidar_planes_finetune300_selftrain/')
