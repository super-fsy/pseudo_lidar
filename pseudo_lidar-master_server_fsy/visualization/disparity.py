...
data_path=root_path+'/Dataset/KITTI/object/training/depth_map/'
...
save_path=root_path+'/Dataset/KITTI/object/predicted_disparity/training/' #可选路径参数testing和training
disparity_number=8
disparity=data_path+'00000'+'%s.npy'%(str(disparity_number))
