...
if __name__ == '__main__':
    ...
    # parser.add_argument('--data_path', type=str, default=root_path+'/Dataset/KITTI/object/training/')
    # parser.add_argument('--split_file', type=str, default=root_path+'/Dataset/KITTI/object/train.txt')
    parser.add_argument('--data_path', type=str, default=root_path+'/Dataset/KITTI/object/training/')
    parser.add_argument('--split_file', type=str, default=root_path+'/Dataset/KITTI/object/train.txt')
    ...
    lidar_dir = args.data_path + '/pseudo-lidar_velodyne_psmnet/'
    calib_dir = args.data_path + '/calib/'
    image_dir = args.data_path + '/image_2/'
    disparity_dir = args.data_path
    disparity_dir=os.path.abspath(os.path.join(disparity_dir, "..")) #上一级目录
    disparity_dir=disparity_dir+'/training/disparity_psmnet/' #修改，为了评价图像
    ...
    for fn in lidar_files:
        ...
        image = imageio.imread(image_file) #修改
