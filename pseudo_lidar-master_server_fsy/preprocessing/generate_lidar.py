...
if __name__ == '__main__':
    ...
    parser.add_argument('--calib_dir', type=str,
                        default=root_path+'/Dataset/KITTI/object/training/calib/')
    parser.add_argument('--disparity_dir', type=str,
                        default=root_path+'/Dataset/KITTI/object/training/predict_disparity_926')
    # parser.add_argument('--disparity_dir', type=str,
    #                     default=root_path+'/Dataset/KITTI/object/training/depth-map_921')
    parser.add_argument('--save_dir', type=str,
                        default=root_path+'/Dataset/KITTI/object/training/predicted_velodyne_926/')
    # parser.add_argument('--save_dir', type=str,
    #                     default=root_path+'/Dataset/KITTI/object/training/depth-map_921/')
    parser.add_argument('--max_high', type=int, default=1)
